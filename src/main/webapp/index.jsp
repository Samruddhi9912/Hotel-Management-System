...
<head>
    ...
    <style>
        ...
        .hero-section { background: linear-gradient(rgba(0,50,0,0.6), rgba(0,50,0,0.6)), url('https://images.unsplash.com/photo-1566073771259-6a8506099945?ixlib=rb-1.2.1&auto=format&fit=crop&w=1350&q=80'); 
    ...
    <div class="container my-5">
        <div class="row g-4">
            <div class="col-md-4">
                <div class="card h-100 shadow-sm border-success">
                    <div class="card-body text-center">
                        <h5 class="card-title text-success">Reservations</h5>
                        <p class="text-muted">Book new guests or update details.</p>
                        <a href="reservationadd.jsp" class="btn btn-success w-100 mb-2">Add New Booking</a>
            ...
            <div class="col-md-4">
                <div class="card h-100 shadow-sm border-success">
                    <div class="card-body text-center">
                        <h5 class="card-title text-success">Modifications</h5>
                        <p class="text-muted">Change or cancel existing stays.</p>
                        <a href="reservationupdate.jsp" class="btn btn-success w-100 mb-2">Update Details</a>
            ...
            <div class="col-md-4">
                <div class="card h-100 shadow-sm border-success">
                    <div class="card-body text-center">
                        <h5 class="card-title text-success">Analytics</h5>
