...
<body class="bg-light">
    <div class="container py-5">
        <div class="text-center mb-5">
            <h1 class="display-5 fw-bold text-success">Analytics & Reports</h1>
            ...
            <div class="col-md-4">
                <div class="card shadow-sm h-100 border-success">
                    <div class="card-body text-center">
                        ...
                        <h5 class="card-title text-success">Date Range Report</h5>
                        <p class="card-text text-muted">View all reservations booked within a specific timeframe.</p>
                        <a href="report_form.jsp" class="btn btn-outline-success stretched-link">Configure</a>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card shadow-sm h-100 border-success">
                    <div class="card-body text-center">
                        <div class="fs-1 mb-3">💰</div>
                        <h5 class="card-title text-success">Revenue Summary</h5>
        ...
        <div class="text-center mt-5">
            <a href="index.jsp" class="btn btn-link text-decoration-none text-success">← Back to Dashboard</a>
        </div>
    </div>
</body>
</html>